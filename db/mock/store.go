...
// Source: github.com/phantom-sage/simplebank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) ListEntrys(ctx context.Context, arg db.ListEntrysParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
